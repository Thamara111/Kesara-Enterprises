                ...
                <?php if (empty($admin_customers)): ?>
                    <div id="empty-state" class="flex flex-col items-center justify-center py-24 text-center gap-4">
                        <div class="w-16 h-16 rounded-2xl bg-gray-100 flex items-center justify-center text-gray-300"><i
                                class="ti ti-users text-3xl"></i></div>
    ...
    <div class="fixed inset-y-0 right-0 z-50 w-1/2 max-w-full bg-gray-50 border-l border-gray-200 flex flex-col shadow-2xl transform translate-x-full transition-transform duration-300 overflow-y-auto"
        ...
        <div class="p-8 border-b border-gray-200 bg-white">
            <div class="flex items-start justify-between mb-6">
                <div class="w-16 h-16 rounded-2xl bg-brand flex items-center justify-center text-white text-xl font-bold shadow-lg shadow-brand/20"
                    id="d-avatar">&mdash;</div>
                <div class="flex items-center gap-3">
                    <span class="px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider hidden"
                        id="d-badge"></span>
                    <button onclick="closeDetailPane()"
        ...
        <div class="p-8 space-y-8 flex-1">
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-[80px_1fr] gap-x-2 gap-y-3 text-xs font-medium">
                    ...
                    <a id="d-whatsapp" href="#" target="_blank"
                        class="text-green-600 font-semibold flex items-center gap-1 hover:underline"><i
                            class="ti ti-brand-whatsapp"></i><span id="d-whatsapp-text">—</span></a>
                </div>
            </div>
