            ...
            <div class="bg-gray-50 rounded-2xl p-6 border border-gray-200">
                ...
                <div class="mt-4">
                    <div class="h-2 bg-gray-200 rounded-full overflow-hidden">
                        <div class="h-full rounded-full transition-all duration-500" id="d-bar"
                            style="width: 9%; background-color: #E24B4A;"></div>
                    </div>
                    <p class="text-xs font-bold mt-2" id="d-status-text" style="color: #791F1F">9% of threshold —
                        restock urgently</p>
                </div>
            </div>
        </div>
        ...
        <div class="p-8 space-y-8 flex-1">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <select id="adj-type" onchange="updateAdjLabel()"
                            class="w-full px-4 py-2.5 rounded-xl border-none ring-1 ring-gray-200 focus:ring-2 focus:ring-brand bg-white text-sm font-medium transition-all">
                    ...
                    <div>
                        <label id="adj-qty-label" class="block text-xs font-bold text-gray-500 mb-1.5">Quantity to
                            add</label>
                        <input type="number" id="adj-qty" value="200" min="0"
                            class="w-full px-4 py-2.5 rounded-xl border-none ring-1 ring-gray-200 focus:ring-2 focus:ring-brand bg-white text-sm transition-all font-bold">
                    </div>

                    <div>
                        <label class="block text-xs font-bold text-gray-500 mb-1.5">Reason / Note</label>
                        <input type="text" placeholder="e.g. Restock batch #42 received" id="adj-note"
                            class="w-full px-4 py-2.5 rounded-xl border-none ring-1 ring-gray-200 focus:ring-2 focus:ring-brand bg-white text-sm transition-all">
                    </div>
                    ...
                    <button
                        class="w-full py-3 rounded-xl bg-brand text-brand-light font-bold text-sm shadow-lg shadow-brand/20 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2"
                        onclick="applyAdj()">
                        Apply adjustment
                    </button>
                </div>
            ...
            <div>
                ...
                <div class="space-y-1" id="adj-log">
                    <div
                        class="flex items-center justify-between p-3 bg-white rounded-xl border border-gray-100 text-xs">
            ...
            <!-- Threshold Update -->
            <div>
                <h3 class="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-4">Update Restock Threshold
                </h3>
                <div class="flex gap-2">
                    <input type="number" id="thresh-input" value="200"
                        class="flex-1 px-4 py-2 rounded-xl border-none ring-1 ring-gray-200 focus:ring-2 focus:ring-brand bg-white text-sm transition-all font-bold">
                    <button onclick="saveThresh()"
                        class="px-6 py-2 rounded-xl border border-gray-200 text-gray-600 font-bold text-sm hover:bg-gray-50 transition-all">
                        Save
                    </button>
                </div>
            </div>
