...
<div id="delete-confirm-modal"
    ...
    <div id="delete-confirm-content"
        class="bg-white p-8 rounded-3xl border border-gray-100 shadow-2xl max-w-sm w-full text-center flex flex-col items-center transform scale-95 opacity-0 transition-all duration-200">
        ...
        <p class="text-sm font-medium text-gray-500 mb-8">Are you sure you want to delete this product? This action
            cannot be undone.</p>
