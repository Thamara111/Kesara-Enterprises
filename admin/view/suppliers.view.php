...
foreach ($admin_suppliers as $s) {
    ...
    if ($status === 'active') $active_suppliers++;
    elseif ($status === 'preferred') $preferred_suppliers++;
    elseif ($status === 'on_hold') $on_hold_suppliers++;
}
?>
<!-- Suppliers View -->
<div class="flex-1 flex overflow-hidden">
    ...
    <div id="suppliers-container" class="flex-1 flex flex-col min-w-0 bg-white">
        ...
        <div class="flex-1 overflow-auto p-6">
            <div class="min-w-[750px]">
                <div class="grid grid-cols-[40px_1.5fr_1fr_1fr_120px_100px] gap-4 px-4 py-3 bg-gray-50 rounded-xl mb-4 text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                    <span></span>
                ...
                <div class="mt-8 flex justify-between items-center bg-gray-50 p-4 rounded-2xl border border-gray-100">
                    <span class="text-xs font-bold text-gray-400">SHOWING <?= $total_suppliers ?> OF <?= $total_suppliers ?> SUPPLIERS</span>
                    <div class="flex gap-2">
                        ...
                        <button class="w-8 h-8 flex items-center justify-center rounded-lg bg-white border border-gray-200 text-gray-450 hover:text-brand transition-colors"><i class="ti ti-chevron-right"></i></button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Detail Pane -->
    <!-- Backdrop -->
    <div id="supplier-detail-backdrop" class="hidden fixed inset-0 bg-black/40 z-40 backdrop-blur-[2px] transition-opacity duration-300" onclick="closeSupplierDetailPane()"></div>
    <div id="supplier-detail-pane" class="fixed inset-y-0 right-0 z-50 w-[400px] max-w-full bg-white border-l border-gray-100 flex flex-col shadow-2xl transform translate-x-full transition-transform duration-300 overflow-y-auto">
        <div class="p-8 flex-1 overflow-y-auto space-y-8">
            <!-- Profile Header -->
            <div class="flex flex-col items-center text-center relative">
                <button onclick="closeSupplierDetailPane()" class="absolute top-0 right-0 p-1.5 text-gray-400 hover:text-brand transition-colors focus:outline-none" aria-label="Close details">
                ...
                <span id="d-badge" class="mt-3 px-4 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-widest border">Preferred</span>
            </div>
            ...
            <section>
                ...
                <div class="space-y-4">
                    <div class="flex justify-between items-center">
                        ...
                        <div class="flex items-center gap-2">
                            <div class="h-1.5 w-16 bg-gray-100 rounded-full overflow-hidden flex-shrink-0">
                                <div id="d-bar-ot" class="h-full rounded-full transition-all duration-500" style="width: 96%"></div>
                            </div>
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <div class="flex items-center gap-2">
                            <div class="h-1.5 w-16 bg-gray-100 rounded-full overflow-hidden flex-shrink-0">
                                <div id="d-bar-qual" class="h-full rounded-full transition-all duration-500" style="width: 98%"></div>
                            </div>
        ...
        <div class="p-6 border-t border-gray-100 bg-gray-50/50 space-y-3">
            <a href="/admin-purchase-orders" class="w-full flex items-center justify-center gap-2 px-4 py-3 bg-brand text-brand-light rounded-xl text-sm font-bold shadow-lg shadow-brand/10 hover:opacity-90 transition-all">
                <i class="ti ti-shopping-cart text-lg"></i>
                Create Purchase Order ↗
            </a>
            <div class="grid grid-cols-2 gap-3">
                <a id="d-edit-link" href="#" class="flex items-center justify-center gap-2 px-4 py-2.5 bg-white border border-gray-200 rounded-xl text-xs font-bold text-gray-700 hover:bg-gray-50 transition-all">
                    <i class="ti ti-edit text-base"></i>
                    Edit
                </a>
                <button id="d-hold-btn" class="flex items-center justify-center gap-2 px-4 py-2.5 bg-white border border-red-100 rounded-xl text-xs font-bold text-red-650 hover:bg-red-50 transition-all">
